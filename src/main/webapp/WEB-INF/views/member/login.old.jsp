...
<head>
<meta charset="UTF-8">
<title>2023. 4. 11.오전 10:37:04</title>
<style>
...
<body>
    ...
    <p>미확인 쪽지의 갯수<span id="unchekedNoteCount">0</span></p>
   ...
   <script src="${pageContext.request.contextPath}/resources/js/note.js"></script>
    ...
    $(function(){
		 ...
		 ws.onopen = function(ev) {
	       ...
	       ws.onmessage = function(ev) {
	    	 ...
	    	 if(obj.sender === sender){
	    	    ...
	    	    $("#unchekedNoteCount").text(receiveUncheckedList.length);
				$(".receiveChekedList").html(getTableText(obj.receiveUncheckedList));
		...
		noteService.getReceiveCheckedList(sender, function(data){// 원래는 'id1' 이였음 참고
			$("#unchekedNoteCount").text(data.length);
			$(".receiveChekedList").html(getTableText(data));
		})
