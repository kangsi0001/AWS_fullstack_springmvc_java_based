		                        ...
		                        <form method="post" id="boardform">
								  ...
								  <div class="form-group">
								    ...
								    <input type="text" class="form-control" name="writer" id="writer"
								           value='<sec:authentication property="principal.member.userName"/>' readonly>
								  ...
								  <div class="form-group">
								    ...
								    <div class="uploadResult my-3">
								      <ul class="list-group-item filenames my-3"></ul>
...
$(function(){
	  $("#btnReg").click(function(){
	     ...
	     $(".filenames li").each(function(i){
	    	 ...
	    	 str += `
	    		  <input type="hidden" name="attachs[\${i}].uuid" value="\${uuid}">//\${$(this).data('uuid')}					  
